...
const NextPageLink = () => {
    return (
        <Link href="karnaval/ticket" ><span style={linkStyle}><h2>See More</h2></span></Link>
    )
}
const Lineup = (props) => {
    return (
        <Container>
            <CenteredWrapper className={props.className}>
                ...
                <p style={{ fontSize: "1em" }}>
                    For two days radio will be streamed from the hall named after Beethoven <br />
                    We will have radio shows, broadcasts, live sessions, screenings <br />
                    Program will be updated regularly
                </p>
                <P>
                    dk.tsk <SmallText text={"[session]"} /> . VHSound & Ensemble . Diezel Tea<br />
                    F.I.X<br />
                    S-pichka<br />
                    LSD Sound-Out Club<br />
                    mu.viz<br />
